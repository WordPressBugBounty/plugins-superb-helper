...
<div class="notice notice-warning settings-error is-dismissible <?php echo esc_attr($notice['unique_id']); ?>">
    ...
    <p>
        <strong>
            <?php echo esc_html__("The following plugin is recommended to enhance your WordPress exprience:", "superb-helper"); ?>
            <a class="thickbox open-plugin-details-modal" href="<?php echo esc_url($spba_plugin_url); ?>">
                <?php echo esc_html__("SuperbThemes", "superb-helper"); ?>
            </a>
        </strong>
    </p>
    ...
    <button type="button" class="notice-dismiss">
        <span class="screen-reader-text">
            <?php echo esc_html__("Dismiss this notice.", "superb-helper"); ?>
        </span>
    </button>
    <style>
